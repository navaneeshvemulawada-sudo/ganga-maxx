...
import { BarChart3, Download, FileSpreadsheet, ArrowUpRight, TrendingUp } from 'lucide-react';
  ...
  return (
    <div className="animate-fade">
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginTop: '0.25rem' }}>
            Examine business intelligence metrics, consumption ratios, and system audit trails.
          </p>
        </div>
        
        <button className="btn btn-primary" style={{ gap: '0.5rem' }}>
          <Download size={16} />
          <span>Export Master Audit Log</span>
        </button>
      </div>
      ...
      <div className="grid-cols-3" style={{ marginBottom: '2rem' }}>
        <div className="card-glass" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '0.5rem' }}>
            <span style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--accent-primary)' }}>₹4,250</span>
        ...
        <div className="card-glass" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '0.5rem' }}>
            <span style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--success)' }}>74.8%</span>
        ...
        <div className="card-glass" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '0.5rem' }}>
            <span style={{ fontSize: '2.25rem', fontWeight: '800', color: 'var(--info)' }}>82.5%</span>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        ...
        <div className="card-glass">
          <h3 style={{ fontSize: '1.125rem', fontWeight: '700', marginBottom: '1rem' }}>Audit Export History</h3>
